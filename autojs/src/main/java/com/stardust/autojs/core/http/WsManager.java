...
public class WsManager implements IWsManager {
    ...
    private void tryReconnect() {
        ...
        Log.e("tryReconnect", "reconnectCount2222222[" + reconnectCount + "]");
        if (!isNetworkConnected(mContext)) {
            setCurrentStatus(WsStatus.DISCONNECTED);
            Log.e("tryReconnect", "[请您检查网络，未连接]");
//            return;
        }
        setCurrentStatus(WsStatus.RECONNECT);
        Log.e("tryReconnect", "reconnectCount11111111[" + reconnectCount + "]");
...
//        wsMainHandler.postDelayed(reconnectRunnable, delay > RECONNECT_MAX_TIME ? RECONNECT_MAX_TIME : delay);
        ...
        Log.e("tryReconnect", "reconnectCount[" + reconnectCount + "]");
        reconnectCount++;
